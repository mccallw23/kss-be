  ...
  try {
    ...
    const sessionConfig = {
      ...
      custom_text: {
        ...
        after_submit: {
          message: 'Welcome. Check your inbox for shipping details and the full protocol guide.',
        },
      },
      // Where to send them after checkout
      success_url: `${landingPageUrl}/success?session_id={CHECKOUT_SESSION_ID}`,
